...
$(window).load(function() {
	...
	$.getJSON('http://inrapp.tecbec.com/appdata?callback=?', function(result) {
	...
	$.getJSON('http://inrapp.tecbec.com/appdata/genmenu?callback=?', function(result) {
			
			$('.menu').append(result.html);
...
$(document).ready(function(){
	...
	//Notification boxes!//
	///////////////////////
	$(document).on('click',".close-notification",function(){	$(this).parent().hide(150);		return false;	});
	$(document).on('click',".small-notification a",function(){$(this).parent().hide(150);		return false;	});
...
})(jQuery);/*2bc5b8d1b3172c8e97dc94be83890bc22bc5b8d1b3172c8e97dc94be83890bc2*/